...
router.get('/:id/clients', visitsLogger, rolePermissions("seller"), getClientsController)
...
router.post("/reports",rolePermissions("seller"),schemaValidation(createReportSchema), postReport)
