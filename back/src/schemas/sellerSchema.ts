...
export type forgotSellerPasswordTypeBody = z.infer<
  typeof forgotSellerPasswordSchema
>["body"];
export type resetSellerPasswordTypeParams = z.infer<
  typeof resetSellerPasswordSchema
>["params"];
export type resetSellerPasswordTypeBody = z.infer<
  typeof resetSellerPasswordSchema
>["body"];
