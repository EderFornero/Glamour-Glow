      ...
      <section className={styles.footermiddlewrapper}>
        ...
        <section>
          <menu>
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/lola-pernigotti-589830276/"
                target="_blank"
                rel="noreferrer"
              >
                Lola Pernigotti
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/sebastian-loda-8a94b3275/"
                target="_blank"
                rel="noreferrer"
              >
                Sebastian Loda
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/moibaldenegro/"
                target="_blank"
                rel="noreferrer"
              >
                Moises Baldenegro
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/ricardo-carrera-silva-546199276/"
                target="_blank"
                rel="noreferrer"
              >
                Ricardo Carrera
