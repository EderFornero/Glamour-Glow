...
// utils
import { sendResetPasswordEmailSeller } from '../../utils'
// router
import { Link } from 'react-router-dom'
// css
import style from './SellerRecovery.module.css'
import { forgotPasswordImage } from '../../Images/FormImages'

const SellerRecovery = (): JSX.Element => {
  const [sellerEmail, setSellerEmail] = useState('')
  // eslint-disable-next-line @typescript-eslint/explicit-function-return-type
  const handleSendResetPassword = async (e: any) => {
    e.preventDefault()
    try {
      const response = await sendResetPasswordEmailSeller(sellerEmail)
